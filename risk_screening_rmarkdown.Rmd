...
boost_fit_rs <-
  final_xgb %>% 
  fit_resamples(sitb_foldsß, control = keep_pred)
toc()
...
* Add features from the text to the model
* Use the tabnet model on all features to see if we can improve performance
